...
import { LiaCheckCircleSolid, LiaCloudSolid, LiaCogSolid, LiaDatabaseSolid, LiaImageSolid, LiaMobileSolid, LiaPaletteSolid, LiaSaveSolid, LiaShieldAltSolid, LiaUploadSolid, LiaUserCogSolid } from 'react-icons/lia';
...
const SystemControl = () => {
    ...
    return <div className="dashboard-layout"><AdminSidebar /><main className="dashboard-content system-control-page">
        ...
        {activeTab === 'collections' && <SystemCollectionsManager />}
    </main></div>;
};
